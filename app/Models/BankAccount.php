...
/**
 * Conta bancária / caixa interno da empresa.
 *
 * Nota: a tabela física permanece como `baccarat_accounts` por
 * compatibilidade com migrations existentes — sem necessidade de rename no DB.
 */
