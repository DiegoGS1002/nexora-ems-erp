    ...
    private static array $modules = [
        ...
        'dashboard' => [
            ...
            'items' => [
                ...
                ['title' => 'Indicadores KPI',  'description' => 'Relatórios e análise de desempenho',         'icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg>', 'route' => 'financial_reports.index'],
            ],
        ],
        ...
        'cadastro' => [
            ...
            'items' => [
                ...
                ['title' => 'Funções',       'description' => 'Cargos e funções dos colaboradores',    'icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="12" cy="8" r="5"/><path d="M20 21a8 8 0 1 0-16 0"/></svg>', 'route' => 'role.index'],
        ...
        'fiscal' => [
            ...
            'items' => [
                ['title' => 'NF-e',      'description' => 'Notas fiscais eletrônicas',           'icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>', 'route' => 'entrance.index'],
                ['title' => 'Entradas',  'description' => 'Notas fiscais de entrada',            'icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><polyline points="16 16 12 12 8 16"/><line x1="12" y1="12" x2="12" y2="21"/><path d="M20.39 18.39A5 5 0 0 0 18 9h-1.26A8 8 0 1 0 3 16.3"/></svg>', 'route' => 'entrance.index'],
                ['title' => 'Saídas',    'description' => 'Notas fiscais de saída',              'icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><polyline points="8 16 12 12 16 16"/><line x1="12" y1="21" x2="12" y2="12"/><path d="M3.51 15a9 9 0 1 0 .49-4.95"/></svg>', 'route' => 'exit.index'],
        ...
        'financeiro' => [
            ...
            'items' => [
                ...
                ['title' => 'Contas Bancárias',   'description' => 'Gestão de contas e bancos',             'icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="1" y="4" width="22" height="16" rx="2" ry="2"/><line x1="1" y1="10" x2="23" y2="10"/></svg>', 'route' => 'baccarat_accounts.index'],
