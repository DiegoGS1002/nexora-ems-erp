...
<div class="nx-form-page">
    ...
    <div class="nx-form-header">
        ...
        <h1 class="nx-form-title">Editar Funcionário</h1>
        <p class="nx-form-subtitle">Atualize os dados de <strong>{{ $employee->name }}</strong></p>
    </div>
        ...
        <div class="nx-form-card">
            <div class="nx-form-section">
                ...
                <div class="grid grid-2">
                    <div class="nx-field">
                        <label>Nome</label>
                        <input type="text" name="name" value="{{ old('name', $employee->name) }}" placeholder="Nome completo" required>
                    </div>
                    <div class="nx-field">
                        <label>CPF</label>
                        <input type="text" name="identification_number" value="{{ old('identification_number', $employee->identification_number) }}" placeholder="000.000.000-00" required>
                    </div>
                </div>
            </div>
            ...
            <div class="nx-form-section">
                ...
                <div class="grid grid-2" style="margin-bottom:16px;">
                    <div class="nx-field">
                        <label>E-mail</label>
                        <input type="email" name="email" value="{{ old('email', $employee->email) }}" placeholder="email@exemplo.com" required>
                    </div>
                    <div class="nx-field">
                        <label>Telefone</label>
                        <input type="text" name="phone_number" value="{{ old('phone_number', $employee->phone_number) }}" placeholder="(00) 00000-0000" required>
                    </div>
                </div>
                <div class="grid grid-1">
                    <div class="nx-field">
                        <label>Endereço</label>
                        <input type="text" name="address" value="{{ old('address', $employee->address) }}" placeholder="Rua, número, bairro, cidade - UF" required>
                    </div>
                </div>
            </div>
