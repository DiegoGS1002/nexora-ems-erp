...
<div class="nx-form-page">
    ...
    <div class="nx-form-header">
        ...
        <h1 class="nx-form-title">Editar Função</h1>
        <p class="nx-form-subtitle">Atualize os dados de <strong>{{ $role->name }}</strong></p>
    </div>
        ...
        <div class="nx-form-card">
            <div class="nx-form-section">
                ...
                <div class="grid grid-2">
                    <div class="nx-field">
                        <label>Nome</label>
                        <input type="text" name="name" value="{{ old('name', $role->name) }}" placeholder="Nome da função" required>
                    </div>
                    <div class="nx-field">
                        <label>Descrição</label>
                        <input type="text" name="description" value="{{ old('description', $role->description) }}" placeholder="Descrição das responsabilidades">
                    </div>
                </div>
            </div>
        </div>
