...
<div class="nx-form-page">
    ...
    <div class="nx-form-header">
        ...
        <h1 class="nx-form-title">Editar Cliente</h1>
        <p class="nx-form-subtitle">Atualize os dados do cliente <strong>{{ $client->name }}</strong></p>
    </div>
        ...
        <div class="nx-form-card">
            <div class="nx-form-section">
                ...
                <div class="grid grid-2">
                    <div class="nx-field">
                        <label>Nome</label>
                        <input type="text" name="name" value="{{ old('name', $client->name) }}" placeholder="Nome completo ou fantasia" required>
                    </div>
                    <div class="nx-field">
                        <label>CNPJ</label>
                        <input type="text" name="taxNumber" value="{{ old('taxNumber', $client->taxNumber) }}" placeholder="00.000.000/0000-00" required>
                    </div>
                </div>
            </div>
            ...
            <div class="nx-form-section">
                ...
                <div class="grid grid-2">
                    <div class="nx-field">
                        <label>E-mail</label>
                        <input type="email" name="email" value="{{ old('email', $client->email) }}" placeholder="email@exemplo.com" required>
                    </div>
                    <div class="nx-field">
                        <label>Telefone</label>
                        <input type="text" name="phone_number" value="{{ old('phone_number', $client->phone_number) }}" placeholder="(00) 00000-0000" required>
                    </div>
                </div>
            </div>
            ...
            <div class="nx-form-section">
                ...
                <div class="grid grid-1" style="margin-bottom:16px;">
                    <div class="nx-field">
                        ...
                        <input type="text" name="address" value="{{ old('address', $client->address) }}" placeholder="Rua, número, bairro, cidade - UF" required>
                    </div>
                </div>
                <div class="grid grid-1">
                    <div class="nx-field">
                        <label>Razão Social</label>
                        <input type="text" name="social_name" value="{{ old('social_name', $client->social_name) }}" placeholder="Razão Social da empresa">
                    </div>
                </div>
            </div>
        </div>
