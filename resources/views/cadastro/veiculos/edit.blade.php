...
<div class="nx-form-page">
    ...
    <div class="nx-form-header">
        ...
        <h1 class="nx-form-title">Editar Veículo</h1>
        <p class="nx-form-subtitle">Atualize os dados de <strong>{{ $vehicle->model }} · {{ $vehicle->plate }}</strong></p>
    </div>
            ...
            <div class="nx-form-section">
                ...
                <div class="grid grid-2">
                    <div class="nx-field">
                        ...
                        <input type="text" name="driver" value="{{ old('driver', $vehicle->driver) }}" placeholder="Nome do motorista (opcional)">
                    </div>
                </div>
            </div>
        </div>
